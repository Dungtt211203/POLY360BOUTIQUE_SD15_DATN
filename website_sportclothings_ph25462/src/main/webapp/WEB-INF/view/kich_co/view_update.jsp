            ...
            <body>
                <div class="formAdd">
                    ...
                    <form:form method="post" modelAttribute="kichCo">
                        ...
                        <div id="tt">
                            <label class="tt">Trạng Thái:</label>
                            <form:radiobutton path="tt" value="0" checked="true" class="radio1" />Hoạt
                            Động
                            <form:radiobutton path="tt" value="1" class="radio" />Không Hoạt Động
                            <br />
                        </div>
                        <form:button type="submit" class="btn btn-success" id="but"
                            onclick="return confirm('Bạn có chắc chắn muốn sửa kích cỡ này?')">Update</form:button>
                    </form:form>
                </div>
            </body>