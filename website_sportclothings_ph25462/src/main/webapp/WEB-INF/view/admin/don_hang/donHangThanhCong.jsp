                        ...
                        $.ajax({
                            ...
                            error: function (error) {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Lỗi!',
                                    text: 'Số Lượng Sản Phẩm Còn Hiện Tại Không Đủ',
                                });
                            }
                        });
                    }
...
<div class="content">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a class="btn btn-info btn1" href="/admin/donHang/donHangCho">Chờ xác nhận</a>
                </div>
                <div class="col-md-2">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                <c:forEach var="donHang" items="${donHangChoXacNhan}">
                    <tr>
